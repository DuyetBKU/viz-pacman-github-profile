...
const argv = yargs(hideBin(process.argv))
    ...
    .option('gameTheme', {
        alias: 'gt',
        describe: 'Game theme: github, github-dark, gitlab, gitlab-dark, dracula, solarized-light, solarized-dark, monokai, react-light, react-dark',
        choices: ['github', 'github-dark', 'gitlab', 'gitlab-dark', 'dracula', 'solarized-light', 'solarized-dark', 'monokai', 'react-light', 'react-dark'],
        demandOption: true,
        type: 'string'
    })
    .option('username', {
