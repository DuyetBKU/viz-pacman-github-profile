...
const DRACULA = ['#282a36', '#44475a', '#6272a4', '#8be9fd', '#50fa7b'];
const SOLARIZED_LIGHT = ['#fdf6e3', '#eee8d5', '#b58900', '#268bd2', '#2aa198'];
const SOLARIZED_DARK = ['#002b36', '#073642', '#586e75', '#b58900', '#859900'];
const MONOKAI = ['#272822', '#75715e', '#f92672', '#fd971f', '#a6e22e'];
const REACT_LIGHT = ['#f5faff', '#cfe8ff', '#9fd1ff', '#61dafb', '#2196f3'];
const REACT_DARK = ['#161b22', '#1e6679', '#1897b4', '#00ddff', '#00ffff'];
...
export const GAME_THEMES: { [key in ThemeKeys]: GameTheme } = {
	...
	'react-light': {
		textColor: '#1565c0',
		gridBackground: '#f5faff',
		wallColor: '#1fb6ff',
		intensityColors: REACT_LIGHT
	},
	...
	'solarized-light': {
		...
		wallColor: '#586e75',
		intensityColors: SOLARIZED_LIGHT
	},
	...
	'solarized-dark': {
		...
		wallColor: '#839496',
		intensityColors: SOLARIZED_DARK
	},
